...
plot_all <- plot_grid(
  ...
  nrow = 3, align = 'h') + #set number of rows, aligned horizontally and vertically, and set relative heights of the plots
...
Needles1 <- ggplot(subset(Litter, functionalGroup == "Needles"), 
  ...
  labs(x = "Date", y = "Dry Mass (g)", title = "Dry Mass of Needles by Date", color = "NLCD Class") #changed labels 
...
Needles2 <- ggplot(subset(Litter, functionalGroup == "Needles"), aes(x = collectDate, y = dryMass)) +
  ...
  labs(x = "Date", y = "Dry Mass (g)", title = "Dry Mass of Needles by Date") #changed labels and title
