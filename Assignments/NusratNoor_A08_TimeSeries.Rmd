...
here()
#creating a sequence from 1981 - other year, do it monthly, will be as a dataframe, use left_join to put together the series and the other part (summary is not enough to check for NAs)
