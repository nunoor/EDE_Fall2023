...
#4 
MGD_df <- data.frame("Month" = c(1, 5, 9, 2, 6, 10, 3, 7, 11, 4, 8, 12),
                     "Year" = rep(2022,12),
...
ggplot(combined_df, aes(x=Date, y=Max_withdrawls, color = PWSID)) +
  geom_line() +
  labs(y="Maximum Day Use (mgd)", title = "2015 Maximum Daily Use per Month", subtitle = "Nusrat Noor") +
  scale_x_date(date_breaks = "1 month", date_labels = "%b")
```
...
the_main_url <- 'https://www.ncwater.org/WUDC/app/LWSP/report.php?pwsid=03-32-010&year='
