...
ggplot(MGD_df,aes(x=Date, y = Max_withdrawls)) +
  geom_line() +
  labs(y="Maximum Withdrawals (MGD)", x="Month", 
       title = "2022 Durham Maximum Monthly Water Withdrawals",
...
ggplot(the_df, aes(x=Date, y=Max_withdrawls)) +
  geom_line() +
  labs(y="Maximum Withdrawals (MGD)", x="Month", 
       title = "2015 Durham Maximum Monthly Water Withdrawals",
       subtitle = "Nusrat Noor") +
  scale_x_date(date_breaks = "1 month", date_labels = "%b")
...
ggplot(combined_df, aes(x=Date, y=Max_withdrawls, color = PWSID)) +
  geom_line() +
  labs(y="Maximum Withdrawals (MGD)", x="Month", 
       title = "2015 Maximum Monthly Water Withdrawals", 
       subtitle = "Nusrat Noor") +
  scale_x_date(date_breaks = "1 month", date_labels = "%b")
...
ggplot(dfs_Ashville, aes(x=Date, y =Max_withdrawls)) +
  ...
  labs(x="Year", y= "Maximum Withdrawals (MGD)", 
       title = "Asheville Max Monthly Water Withdrawals (2010-2021)", 
       subtitle = "Nusrat Noor") +
