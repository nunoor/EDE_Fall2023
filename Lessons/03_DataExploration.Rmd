...
setwd("/home/EDE_Fall2023") #doesnt work because i dont have that directory but this is how i would do it for a directory i do have
```
...
read.csv("C:/users/nn107/Documents/EDE_Fall2023/Data/Raw/USGS_Site02085000_Flow_Raw.csv",stringsAsFactors = TRUE)
...
read.csv(file.choose(USGS.flow.data),stringsAsFactors = TRUE)
