...
1. geom_density of ozone (y) divided by year (x) (distinguish between years by adding transparency to the geom_density layer).
...
ggplot(EPAair, aes(x = Ozone, fill = as.factor(Year))) +
  ...
  labs(x="Ozone AQI value", y="Density", fill="") #means i dont need a title to the fill 
...
summary(pm25_ozone)
#is significant but r-squared is only 13% so ozone only dictates 13% of the PM2.5
