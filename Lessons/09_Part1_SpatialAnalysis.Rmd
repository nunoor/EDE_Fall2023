...
the_buffer <- sf_GraingerHall %>% st_buffer(1) #the 1 is 1 degree of buffer
...
EPAair.sf.utm <- st_transform(EPAair.sf,32617) #represents UTM zone 17 north, reprojects coordinates to use the designated coordinate system
...
distance_matrix <- st_distance(EPAair.sf.utm, GasPlants.utm, pairwise=T) #pairwise- distance matrix
